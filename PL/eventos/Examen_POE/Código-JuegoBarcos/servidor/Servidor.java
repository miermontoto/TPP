...
class Servidor {
	private static void registrarOperaciones(CommServer com) {
		...
		// Descomentar para registrar correctamente la operación coordenadasTiro(str)
		// en la nueva versión y comentar la previa:
//		com.addAction("coordenadasTiro",
//				(o, x) -> ((Servicio)o).coordenadasTiro((String) x[0]), true);
